...
Monster = function(type, x, y, drawChar, drawColor) {
	this._type = type;
	this._x = x;
	this._y = y;
...
Monster.prototype.getType = function() { return this._type; }
...
Terrain = function(type, drawChar, darkChar, darkColor, blocksLOS, blocksMovement) {
	this._type = type;
	this._drawChar = drawChar;
	this._darkChar = darkChar;
	this._darkColor = darkColor;
