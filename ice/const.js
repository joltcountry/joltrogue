...
//TERRAINS
const TERRAIN_FLOOR = new Terrain("floor", " ", "#666", "#222", "#222", "#000", null, false, false, "5");
...
const TERRAIN_DOWNSTAIRS = new Terrain("downstairs", ">", "#6f6", "#333", "#222", "#000", false, false, "8");
const TERRAIN_UPSTAIRS = new Terrain("upstairs", "<", "#66f", "#333", "#000", "#000", false, false, "9");
