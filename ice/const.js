...
//TERRAINS
const TERRAIN_FLOOR = new Terrain("floor", " ", "#666", DEFAULT_FLOOR, DEFAULT_FLOOR, DEFAULT_DARK, null, false, false, "5");
const TERRAIN_WALL = new Terrain("wall", "^", "#fff", "#334", "#339", DEFAULT_DARK, true, true, "3");
...
const TERRAIN_DOWNSTAIRS = new Terrain("downstairs", ">", "#6f6", "#242", DEFAULT_FLOOR, DEFAULT_DARK, false, false, "8");
const TERRAIN_UPSTAIRS = new Terrain("upstairs", "<", "#6f6", "#242", DEFAULT_FLOOR, DEFAULT_DARK, false, false, "9");
